...
namespace WebApplication2.Migrations
{
    ...
    [Migration("20260731143402_ExtendPriceHistoryLedger")]
    partial class ExtendPriceHistoryLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication2.Models.PriceHistory", b =>
                {
                    ...
                    b.Property<string>("PriceKind")
                        ...
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
                        .HasDefaultValue("EffectivePrice");
                    ...
                    b.HasIndex("ProductVariantId", "PriceKind", "EffectiveFrom", "CreatedAt");

                    b.ToTable("PriceHistories", t =>
                        {
                            t.HasCheckConstraint("CK_PriceHistory_Currency", "LEN([Currency]) = 3 AND [Currency] = UPPER([Currency])");

                            t.HasCheckConstraint("CK_PriceHistory_EventType", "[EventType] IN ('Applied','Restored','Replaced','Cancelled','ListPriceChanged','EffectivePriceChanged','Legacy')");

                            t.HasCheckConstraint("CK_PriceHistory_NewPrice", "[NewPrice] > 0");

                            t.HasCheckConstraint("CK_PriceHistory_OldPrice", "[OldPrice] > 0");

                            t.HasCheckConstraint("CK_PriceHistory_PriceKind", "[PriceKind] IN ('ListPrice','EffectivePrice')");
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductOptionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductOptionGroups", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProductOptionGroup_DisplayOrder", "[DisplayOrder] >= 0 AND [DisplayOrder] <= 9999");
                        });
                });

            modelBuilder.Entity("WebApplication2.Models.ProductOptionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OptionGroupId", "IsActive", "DisplayOrder");

                    b.ToTable("ProductOptionValues", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProductOptionValue_DisplayOrder", "[DisplayOrder] >= 0 AND [DisplayOrder] <= 9999");
                        });
                });
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductId", "Status", "SubmittedAt");
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductReviewMedia", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ProductReviewMedia", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProductReviewMedia_DisplayOrder", "[DisplayOrder] >= 0 AND [DisplayOrder] <= 4");
                        });
                });

            modelBuilder.Entity("WebApplication2.Models.ProductReviewMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductReviewId", "SentAt", "Id");

                    b.ToTable("ProductReviewMessages", (string)null);
                });

            modelBuilder.Entity("WebApplication2.Models.ProductReviewReply", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductVariantOptionSelection", b =>
                {
                    b.Property<int>("VariantId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("VariantId", "OptionGroupId");

                    b.HasIndex("OptionGroupId", "OptionValueId");

                    b.ToTable("ProductVariantOptionSelections", (string)null);
                });
            ...
            modelBuilder.Entity("WebApplication2.Models.ReturnRefundAccount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ReturnRefundAccounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReturnRefundAccount_AccountNumber", "LEN([AccountNumber]) >= 6 AND LEN([AccountNumber]) <= 24");
                        });
                });
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductOptionValue", b =>
                {
                    b.HasOne("WebApplication2.Models.ProductOptionGroup", "OptionGroup")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductReview", b =>
                {
                    ...
                    b.HasOne("WebApplication2.Models.OrderItem", "OrderItem")
                        .WithOne("Review")
                        .HasForeignKey("WebApplication2.Models.ProductReview", "OrderItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductReviewMedia", b =>
                {
                    b.HasOne("WebApplication2.Models.ProductReview", "ProductReview")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductReviewReply", b =>
                {
                    b.HasOne("WebApplication2.Models.ProductReview", "ProductReview")
                        .WithOne("Reply")
                        .HasForeignKey("WebApplication2.Models.ProductReviewReply", "ProductReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication2.Models.ProductVariantOptionSelection", b =>
                {
                    ...
                    b.HasOne("WebApplication2.Models.ProductOptionValue", "OptionValue")
                        .WithMany("VariantSelections")
                        .HasForeignKey("OptionGroupId", "OptionValueId")
                        .HasPrincipalKey("OptionGroupId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication2.Models.ReturnRefundAccount", b =>
                {
                    b.HasOne("WebApplication2.Models.ReturnRequest", "ReturnRequest")
                        .WithOne("RefundAccount")
                        .HasForeignKey("WebApplication2.Models.ReturnRefundAccount", "ReturnRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
